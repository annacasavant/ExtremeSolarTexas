...
new_buses = [
    (500, "DAWN_SOLAR 0", 2000,ACBusTypes.PQ),
    (500, "FRYE_SOLAR 0", 2000,ACBusTypes.PQ),
    (500, "ANDREWS 0 0", 1000,ACBusTypes.PQ),
    (500, "EUNICE_SOLAR 0", 1000,ACBusTypes.PQ),
    (500, "LAMESA 1", 1000,ACBusTypes.PQ),
    (500, "STANTON 1", 1000,ACBusTypes.PQ),
    (500, "COLORADO CITY 1", 3000,ACBusTypes.PQ),
    (500, "SAN ANGELO 1 1", 3000,ACBusTypes.PQ),
    (500, "MCCAMEY 1 2", 1000,ACBusTypes.PQ),
    (500, "MISAE_SOLAR 1 0", 2000,ACBusTypes.PQ),
    (230, "MISAE_SOLAR 1 1", 2000,ACBusTypes.PQ),
    (230, "MISAE_SOLAR 2 0", 2000,ACBusTypes.PQ),
    (500, "SHORTON 2", 2000,ACBusTypes.PQ),
    (115, "RADIAN_INCREASE 1", 5000,ACBusTypes.PQ),
    (115, "EARLY 1", 5000,ACBusTypes.PQ),
    (230, "QUEMADO 1", 4000,ACBusTypes.PQ),
    (230, "TREVINO_SOLAR 1", 4000,ACBusTypes.PQ),
    (115, "HALF_MOON_SOLAR 1", 4000,ACBusTypes.PQ),
    (115, "STILLWATER_SOLAR", 4000,ACBusTypes.PQ),
    (115, "MILLHOUSE_SOLAR", 4000,ACBusTypes.PQ),
    (115, "GSE_ELEVEN", 8000,ACBusTypes.PQ),
    (115, "CAUSE_SOLAR", 6000,ACBusTypes.PQ),
    (115, "SOLEMIO 1", 8000,ACBusTypes.PQ),
    (161, "RADIAN 0", 5000,ACBusTypes.PQ),
    (161, "HSHOE_BEND 0", 5000,ACBusTypes.PQ),
    (161, "OWENS_SOLAR", 5000,ACBusTypes.PQ),
    (161, "SPECTRUM_SOLAR 0", 5000,ACBusTypes.PQ),
    (161, "FRENCH_G_SOLAR 1", 5000,ACBusTypes.PQ),
    (161, "VISION_SOLAR 1", 5000,ACBusTypes.PQ),
    (161, "SANDINE_SOLAR", 2000,ACBusTypes.PQ),
    (161, "OBSIDIAN_SOLAR", 2000,ACBusTypes.PQ),
    (161, "CITRINE_SOLAR", 2000,ACBusTypes.PQ),
    (161, "SUN_VALLEY 1", 5000,ACBusTypes.PQ),
    (161, "SUN_VALLEY 2", 5000,ACBusTypes.PQ),
    (161, "ANGUS_SOLAR", 5000,ACBusTypes.PQ),
    (161, "MARKUM_SOLAR", 5000,ACBusTypes.PQ),
    (161, "FRYE_SOLAR 1", 2000,ACBusTypes.PQ),
    (161, "CASTRO_SOLAR 0", 2000,ACBusTypes.PQ),
    (161, "NAZARETH_SOLAR 0", 2000,ACBusTypes.PQ),
    (230, "WEST COLUMBIA 1", 7000,ACBusTypes.PQ),
    (230, "IMPACT_SOLAR", 8000,ACBusTypes.PQ),
    (230, "PINE_FOREST_SOLAR 1", 8000,ACBusTypes.PQ),
    (230, "TRI_COUNTY_SOLAR 1", 1000,ACBusTypes.PQ),
    (230, "TULSITA_SOLAR 1", 4000,ACBusTypes.PQ),
    (230, "DIAMONDBACK_SOLAR 1", 4000,ACBusTypes.PQ),
    (230, "ANGELINA_SOLAR 1", 8000,ACBusTypes.PQ),
    (230, "SMITHLAND_SOLAR 1", 5000,ACBusTypes.PQ),
    (230, "WAKE_SOLAR", 2000,ACBusTypes.PQ),
    (230, "PFLUGERVILLE_SOLAR 2", 6000,ACBusTypes.PQ),
    (230, "ZORRO_SOLAR", 4000,ACBusTypes.PQ),
    (230, "CORAZON_SOLAR", 4000,ACBusTypes.PQ),
    (230, "DOVE_RUN", 4000,ACBusTypes.PQ),
    (230, "ROSELAND_SOLAR", 8000,ACBusTypes.PV),
    (230, "RAYOS_DEL_SOL", 4000,ACBusTypes.PQ),
    (230, "ARROYO_SOLAR", 4000,ACBusTypes.PQ),
    (230, "FRONTON_SOLAR", 4000,ACBusTypes.PQ),
    (230, "STARR_SOLAR", 4000,ACBusTypes.PQ),
    (230, "WESTORIA_SOLAR 1", 7000,ACBusTypes.PQ),
    (230, "WAGYU_SOLAR 1", 7000,ACBusTypes.PQ),
    (230, "HOPKINS 1", 8000,ACBusTypes.PQ),
    (230, "MOUNT VERNON 1", 8000,ACBusTypes.PQ),
    (161, "SPANISH CROWN 1", 5000,ACBusTypes.PQ),
    (500, "SAMSON SOLAR 3 0", 2000,ACBusTypes.PQ),
    (500, "SAMSON SOLAR 1 0", 2000,ACBusTypes.PQ),
    (500, "NOTREES 1", 1000,ACBusTypes.PQ),
    (500, "ODESSA 5 1", 1000,ACBusTypes.PQ),
    (500, "ODESSA 6 1", 1000,ACBusTypes.PQ),
    (500, "ANDREWS 1", 1000,ACBusTypes.PQ),
    (500, "MBAR_SOLAR", 1000,ACBusTypes.PQ),
    (500, "WHATLEY_SOLAR", 1000,ACBusTypes.PQ),
    (500, "DESERT_ROSE_SOLAR", 1000,ACBusTypes.PQ),
    (500, "RODEO_SOLAR", 1000,ACBusTypes.PQ),
    (500, "CHARBRAY_SOLAR", 1000,ACBusTypes.PQ),
    (115, "NORTON_SOLAR", 3000,ACBusTypes.PQ),
    (230, "BLUE_BELL 2 0", 3000,ACBusTypes.PQ),
    (115, "BLUE_BELL 2 1", 3000,ACBusTypes.PQ),
    (115, "BLUE_BELL", 3000,ACBusTypes.PQ),
    (115, "PRICKLY_PEAR", 3000,ACBusTypes.PQ),
    (230, "ODONNELL 1", 1000,ACBusTypes.PQ),
    (500, "JUNO_SOLAR", 1000,ACBusTypes.PQ),
    (500, "GREEN_HOLLY", 1000,ACBusTypes.PQ),
    (500, "OXBOW_SOLAR", 3000,ACBusTypes.PQ),
    (500, "GOODRANCH_SOLAR", 3000,ACBusTypes.PQ),
    (500, "RAMSEY_SOLAR", 7000,ACBusTypes.PQ),
    (230, "QUEEN_SOLAR", 1000,ACBusTypes.PQ),
    (230, "FIGHTING_JAYS", 7000,ACBusTypes.PQ),
    (115, "HALLMARK_SOLAR", 5000,ACBusTypes.PQ),
    (161, "PHOENIX_SOLAR", 2000,ACBusTypes.PQ),
    (230, "HOLSTEIN 1", 3000,ACBusTypes.PQ),
    (230, "HOLSTEIN 2", 3000,ACBusTypes.PQ),
    (230, "THICKGRASS SOLAR", 7000,ACBusTypes.PQ),
    (161, "HILL_SOLAR", 5000,ACBusTypes.PQ),
    (115, "BLUE_JAY_SOLAR", 8000,ACBusTypes.PQ),
    (161, "CONIGLIO_SOlAR", 1000,ACBusTypes.PQ),
    (230, "SABINAL 1", 3000,ACBusTypes.PQ),
    (230, "UVALDE 1", 3000,ACBusTypes.PQ),
    (230, "GLOVE_SOLAR", 3000,ACBusTypes.PQ),
    (115, "BASALT_SOLAR", 3000,ACBusTypes.PQ),
    (115, "FLUORITE_SOLAR", 3000,ACBusTypes.PQ),
    (115, "SPINEL_SOLAR", 6000,ACBusTypes.PQ),
    (230, "CROWDED_STAR_SOLAR", 3000,ACBusTypes.PQ),
    (230, "HAMLIN 1", 3000,ACBusTypes.PQ),
    (115, "INDIGO_SOLAR", 3000,ACBusTypes.PQ),
    (115, "DISCO_SOLAR", 3000,ACBusTypes.PQ),
    (230, "ELROND", 3000,ACBusTypes.PQ),
    (230, "ROCHESTER 1", 2000,ACBusTypes.PQ),
    (230, "OLNEY 1 3", 5000,ACBusTypes.PQ),
    (115, "MUSTANG_CREEK", 7000,ACBusTypes.PQ),
    # Added For Hydropower
    (230, "AMISTAD_HYDRO 0", 4000,ACBusTypes.PQ),
    (18, "AMISTAD_HYDRO 1 1", 4000,ACBusTypes.PV),
    (18, "AMISTAD_HYDRO 1 2", 4000,ACBusTypes.PV),
    (18, "BUCHANAN DAM 1 3", 3000,ACBusTypes.PV),
    (18, "INKS 1", 3000,ACBusTypes.PV),
    (18, "MARSHALL FORD 1", 6000,ACBusTypes.PV),
    (18, "MARSHALL FORD 2", 6000,ACBusTypes.PV),
    (18, "MARSHALL FORD 3", 6000,ACBusTypes.PV),
    (18, "WHITNEY DAM 2", 5000,ACBusTypes.PV),
]
